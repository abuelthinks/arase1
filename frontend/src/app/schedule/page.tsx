...
function SchedulePausedContent() {
  return (
    <div className='mx-auto flex min-h-[60vh] w-full max-w-3xl items-center px-4 md:px-0'>
      <section className='w-full rounded-2xl border border-line bg-card p-6 shadow-sm md:p-8'>
        <div className='flex flex-col gap-4 sm:flex-row sm:items-start'>
          <div className='flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-subtle-soft text-muted'>
            <CalendarClock className='h-6 w-6' aria-hidden='true' />
          </div>
          <div className='flex-1'>
            <h1 className='m-0 text-2xl font-extrabold text-fg'>Assessment Scheduling Is Paused</h1>
            ...
            <div className='mt-5 flex flex-wrap gap-3'>
              ...
              <Link
                href='/dashboard'
                className='inline-flex items-center rounded-xl border border-line px-4 py-2.5 text-sm font-bold text-fg no-underline hover:bg-app'
              >
                Back to Dashboard
              </Link>
            </div>
