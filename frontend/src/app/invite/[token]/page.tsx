...
export default function AcceptInvitePage() {
    ...
    if (success) {
        return (
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "var(--bg-light)" }}>
                <div style={{ background: "var(--bg-secondary)", padding: "3rem", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0,0,0,0.1)", textAlign: "center" }}>
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", background: "linear-gradient(135deg, var(--bg-primary) 0%, var(--border-light) 100%)", padding: "1rem" }}>
            <div style={{ background: "rgba(255, 255, 255, 0.8)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", padding: "2rem", borderRadius: "16px", boxShadow: "0 20px 40px -10px rgba(0,0,0,0.05), 0 0 0 1px rgba(255,255,255,0.6) inset", width: "100%", maxWidth: "420px", display: "flex", flexDirection: "column", gap: "1.2rem", transition: "all 0.3s ease" }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                    <div>
                        <label style={{ display: "block", marginBottom: "4px", fontSize: "0.8rem", fontWeight: 600, color: "var(--text-secondary)" }}>Email Address</label>
                        <input
                            type="email"
                            disabled
                            style={{ 
                                width: "100%", padding: "10px 12px", borderRadius: "8px", 
                                border: "1px solid var(--border-light)", boxSizing: "border-box",
                                background: "var(--bg-neutral-light)", color: "var(--text-secondary)", cursor: "not-allowed",
