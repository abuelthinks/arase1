...
from .views import (
    ...
    GenerateReportDraftView, GenerateReportFinalView,
    ParentOnboardView, StudentProfileView,
    RequestAssessmentView, AssignSpecialistView, AssignTeacherView, UnassignStaffView, ConfirmTeamView, AssignParentView, ParentAssessmentReminderView, SpecialistAssessmentReminderView,
...
urlpatterns = [
    ...
    path('students/<int:student_id>/confirm-team/', ConfirmTeamView.as_view(), name='confirm-team'),
    ...
    path('students/<int:student_id>/specialist-assessment-reminder/', SpecialistAssessmentReminderView.as_view(), name='specialist-assessment-reminder'),
    path('students/<int:student_id>/enroll/', EnrollStudentView.as_view(), name='enroll-student'),
    path('students/<int:student_id>/integrate/', IntegrateStudentView.as_view(), name='integrate-student'),
    ...
    path('inputs/multidisciplinary-assessment/sections/<str:section_key>/reopen/',
         AssessmentSectionReopenView.as_view(), name='assessment-section-reopen'),
    ...
    path('inputs/multidisciplinary-assessment/submit-all/',
         AssessmentSubmitAllView.as_view(), name='assessment-submit-all'),
    path('inputs/multidisciplinary-assessment/request-unlock/',
         AssessmentRequestUnlockView.as_view(), name='assessment-request-unlock'),
    path('inputs/multidisciplinary-assessment/unlock/',
         AssessmentUnlockView.as_view(), name='assessment-unlock'),
    path('inputs/parent-assessment/request-unlock/',
         ParentAssessmentRequestUnlockView.as_view(), name='parent-assessment-request-unlock'),
    path('inputs/parent-assessment/unlock/',
         ParentAssessmentUnlockView.as_view(), name='parent-assessment-unlock'),
    ...
    path('inputs/multidisciplinary-tracker/sections/<str:section_key>/reopen/',
         TrackerSectionReopenView.as_view(), name='tracker-section-reopen'),
